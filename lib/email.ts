...
export const sendOTPEmail = async (email: string, otp: string) => {
  const mailOptions = {
    from: `"Anvil Attendance" <${process.env.DEFAULT_FROM_EMAIL}>`,
    to: email,
    subject: 'Your Anvil Attendance Verification Code',
    html: `
      <div style="font-family: 'DM Sans', sans-serif; max-width: 600px; margin: 0 auto; border: 1px solid #EDE9FE; border-radius: 12px; overflow: hidden;">
        ...
        <div style="padding: 40px; background-color: #FFFFFF;">
          ...
          <p style="color: #6B7280; font-size: 16px; margin-bottom: 30px;">Use the following code to complete your registration for Anvil Attendance.</p>
        ...
        <div style="padding: 20px; background-color: #FAFAFF; border-top: 1px solid #EDE9FE; text-align: center;">
          <p style="color: #6B7280; font-size: 12px; margin: 0;">&copy; ${new Date().getFullYear()} Anvil Automation. All rights reserved.</p>
        </div>
      </div>
    `,
  };
